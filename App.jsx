...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card.col-sports   { border-left-color: #f97316; }
  .card.col-events   { border-left-color: #ff2d78; }
  .card.col-nature   { border-left-color: #22c55e; }
  .card.col-arts     { border-left-color: #a78bfa; }
  .card.col-play     { border-left-color: #00e6e6; }
  .results-map { max-width: 720px; margin: 0 auto 32px; padding: 0 24px; }
  .results-map-inner { border-radius: 16px; overflow: hidden; border: 1px solid rgba(0,230,230,0.2); box-shadow: 0 4px 24px rgba(0,0,0,0.4); }
  .results-map-header { background: rgba(7,9,26,0.97); padding: 12px 16px; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid rgba(0,230,230,0.15); }
  .results-map-header span { font-family: 'Exo 2', sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #00e6e6; }
  #results-map-container { height: 340px; width: 100%; }
  .leaflet-popup-content-wrapper { background: #0d1535; border: 1px solid rgba(0,230,230,0.3); border-radius: 10px; color: #e8f0ff; font-family: 'Exo 2', sans-serif; box-shadow: 0 4px 20px rgba(0,0,0,0.6); }
  .leaflet-popup-tip { background: #0d1535; }
  .leaflet-popup-content { margin: 10px 14px; font-size: 12.5px; line-height: 1.5; }
  .leaflet-popup-content strong { color: #00e6e6; display: block; margin-bottom: 2px; font-size: 13px; }
...
const SOURCE_META = {
  sports:  { col: "col-sports",  label: "🏟️ Sports & Games" },
  events:  { col: "col-events",  label: "🎉 Events & Festivals" },
  nature:  { col: "col-nature",  label: "🌿 Nature & Outdoors" },
  arts:    { col: "col-arts",    label: "🎨 Arts & Culture" },
  play:    { col: "col-play",    label: "🏄 Play & Activities" },
  ai:      { col: "col-play",    label: "✨ AI pick" },
  static:  { col: "col-play",    label: "📌 Saved" },
  live:    { col: "col-events",  label: "🔍 Live result" },
};

// Always-on static venues (hours/pricing never changes much)
const STATIC_VENUES = [
  { id: "pirateaquatours", lat: 25.7762, lng: -80.1839, name: "Miami Pirate Sightseeing Cruise — Miami Aqua Tours", location: "Pier 5, Bayside Marketplace · 401 Biscayne Blvd, Miami 33132", description: "Board the pirate ship El Loro for a 1h20min cruise through Biscayne Bay past Star Island celebrity mansions, Venetian Islands, Fisher Island, and the downtown Miami skyline. Kids get pirate hats, bilingual narration (English/Spanish), music on board, restroom on board. Snacks, drinks, and souvenir photos available. Also passes filming locations from Bad Boys, Scarface, Iron Man & Fast & Furious. Book online or call 305-358-7600.", setting: "outdoor", estimatedCost: "$30/adult (13+) · $20/child (0–12)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏴‍☠️", source: "nature", typicalHours: "Multiple departures daily — check miamiaquatours.com for times", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://miamiaquatours.com/cruises/pirate-adventure/" },
  { id: "ipaddle", lat: 25.8253, lng: -80.1694, name: "iPaddle Miami — Kayak & Paddleboard on Biscayne Bay", location: "1275 NE 79th St, Miami 33138 (79th St Causeway) · Also: Chapman Field Park, South Miami", description: "One of Miami's best on-the-water experiences — kayak and paddleboard rentals, guided tours, and lessons right on Biscayne Bay. Explore calm waters, nearby islands, and often spot dolphins, manatees, rays, and turtles. Kids SUP & kayak lessons (ages 8–15, must swim); kids can ride as passengers from age 5 with an adult. Nighttime full moon tours also available. Reservation required — book at ipaddlemiami.com. Water shoes required (ramp is rocky). Bilingual (English/Spanish).", setting: "outdoor", estimatedCost: "Rentals from ~$40–$60/hr · Kids lessons — check site · Tours vary", ageRange: "Ages 5+ (passengers) · Ages 8–15 (kids lessons)", ageMin: 5, ageMax: 17, emoji: "🛶", source: "nature", typicalHours: "Daily sunrise to sunset · Night tours available · Reservation required", seasonalNote: "Often spot dolphins, manatees & sea turtles on the water!", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://ipaddlemiami.com/" },
  { id: "puttshack", lat: 25.7617, lng: -80.1918, name: "Puttshack Miami", location: "701 S Miami Ave, Level 4, Brickell City Centre", description: "High-tech mini golf with patented ball-tracking, outdoor terrace overlooking the Miami River, and a full restaurant. Kids 12 and under: $10/round or $15 all-you-can-putt Sun–Fri. 21+ after 9pm Fri & Sat.", setting: "indoor", estimatedCost: "$10–$15/child", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⛳", source: "play", typicalHours: "Sun 11am–10pm · Mon–Thu 11am–11pm · Fri–Sat 11am–1am", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.puttshack.com/locations/miami/" },
  { id: "superblue", lat: 25.7987, lng: -80.2269, name: "Superblue Miami", location: "1101 NW 23rd St, Allapattah (near Wynwood)", description: "Over 50,000 sq ft of immersive art by teamLab, Es Devlin, and James Turrell — mirrored labyrinths, digital flower worlds, and a 3,000-bulb heartbeat installation. Kids under 3 free; Florida residents get a discount.", setting: "indoor", estimatedCost: "~$17/child · $29+ adults · Under 3 free", ageRange: "All ages (best 3+)", ageMin: 0, ageMax: 17, emoji: "🎨", source: "arts", typicalHours: "Mon–Thu 11am–7pm · Fri–Sat 10am–8pm · Sun 10am–7pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.superblue.com/miami" },
  { id: "zoo", lat: 25.6128, lng: -80.4001, name: "Zoo Miami", location: "12400 SW 152nd St, South Miami", description: "2,000+ animals across 340 acres. Features animal encounters, VIP cart tours, safari cycles, and a botanical garden. Kids 2 and under free. Parking always free. $1 Kids Night select Mondays; $5 weekday summer tickets Mon–Thu.", setting: "outdoor", estimatedCost: "$21.95/child (3–12) · Under 2 free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🦒", source: "nature", typicalHours: "Daily 10am–5pm (last ticket 4pm)", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.zoomiami.org" },
  { id: "fairchild", lat: 25.6757, lng: -80.2748, name: "Fairchild Tropical Botanic Garden", location: "10901 Old Cutler Rd, Coral Gables", description: "83 acres of tropical plants, butterfly garden, rainforest, and children's garden. Free tram rides included. Kids 5 and under free. Fairies in the Garden scavenger hunt running now.", setting: "outdoor", estimatedCost: "$11.95/child (6–17) · Under 6 free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌿", source: "nature", typicalHours: "Daily 10am–5pm (closed Christmas)", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://fairchildgarden.org" },
  { id: "birdbowl", lat: 25.7254, lng: -80.3319, name: "Bird Bowl Bowling Center", location: "9275 SW 40th St (Bird Road), Miami", description: "60-lane bowling plus arcade, laser tag, mini golf, billiards, karaoke, and a kids menu. After-school special: $3/game Mon–Fri 3–6pm on school days. Saturday Funday: 1hr bowling + pizza + soda + $20 arcade card for $69.95/lane.", setting: "indoor", estimatedCost: "$3–$5.50/game daytime", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎳", source: "play", typicalHours: "Sun–Thu 10am–12am · Fri–Sat 10am–2am", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://birdbowl.com" },
  { id: "frost", lat: 25.7851, lng: -80.1852, name: "Frost Museum of Science", location: "1101 Biscayne Blvd, Museum Park, Downtown Miami", description: "Miami's premier science museum with a three-story aquarium, live coral reef, immersive exhibitions, and planetarium shows. Explorer Ticket covers museum + aquarium + one planetarium show. Under-3s free. First responders and military free.", setting: "indoor", estimatedCost: "$24.95/child (4–11) · $29.95/adult · Under 3 free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🔭", source: "arts", typicalHours: "Mon–Thu 10am–5pm · Fri–Sun 10am–6pm · Open every day", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.frostscience.org/plan-your-day/" },
  { id: "berryfarm", lat: 25.4983, lng: -80.4619, name: "The Berry Farm", location: "13720 SW 216th St, Miami, FL 33170 (Redland area)", description: "Miami's countryside farm destination with u-pick flower and berry fields, hayrides, shaded playgrounds, bounce floors, obstacle courses, and seasonal festivals. The Flower Festival is running now with sunflowers, zinnias, and snapdragons in bloom. Closed Mondays. Note: closed Apr 18 for a private event.", setting: "outdoor", estimatedCost: "Check site — varies by event", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌻", source: "nature", typicalHours: "Mon closed · Tue–Thu 10am–6:30pm · Fri & Sun 9am–7pm · Sat 9am–6:30pm", seasonalNote: "Flower Festival running now! Free mulberry picking this weekend (Apr 11–12) while supplies last.", eventDate: null, daysOpen: [0,2,3,4,5,6], url: "https://www.visittheberryfarm.com/" },
  { id: "tinezfarms", lat: 25.515, lng: -80.447, name: "Tinez Farms", location: "16405 SW 177th Ave, Miami, FL 33187 (Redland area)", description: "Family-owned pesticide-free farm with pony rides, zip lines, a tubing slide, animal encounters, a bounce house, and seasonal produce. Known for excellent seasonal festivals including Easter egg hunts and a fall pumpkin patch. Closed Mondays. Tickets vary by season and event.", setting: "outdoor", estimatedCost: "Check site — varies by season", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🐴", source: "nature", typicalHours: "Mon closed · Tue–Fri 10am–5pm · Sat–Sun 10am–6pm", seasonalNote: null, eventDate: null, daysOpen: [0,2,3,4,5,6], url: "https://www.tinezfarms.com/" },
  { id: "jungleisland", lat: 25.7835, lng: -80.1867, name: "Jungle Island", location: "1111 Parrot Jungle Trail, Watson Island, Miami", description: "Miami's iconic eco-adventure park on Watson Island — wildlife exhibits, Treewalk Village, Everglades habitat, Guardians of the Jungle show, playground, petting zoo, and add-on animal encounters with sloths, capybaras, lemurs, flamingos, and more. Just 10 minutes from Downtown Miami.", setting: "outdoor", estimatedCost: "$19.95/child (3–9) · $29.95/adult · Under 3 free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🦜", source: "nature", typicalHours: "Daily 9:30am–5pm (last admission 4pm) · Animal Encounters 9am–4pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.jungleisland.com/" },
  { id: "vizcaya", lat: 25.7449, lng: -80.2112, name: "Vizcaya Museum & Gardens", location: "3251 S Miami Ave, Coconut Grove / Brickell, Miami", description: "James Deering's stunning 1916 Italian Renaissance waterfront estate — 10 acres of formal gardens, a coral-rock barge on Biscayne Bay, and a mansion packed with antiques. Currently discounted adult admission ($20) during ongoing restoration. Kids 5 and under free. SNAP/EBT cardholders and veterans free. Free Sunday Farmers Market in the Village (9am–2pm, no estate admission needed).", setting: "outdoor", estimatedCost: "$20/adult (discounted) · $10/child (6–12) · Under 5 free", ageRange: "All ages (best 5+)", ageMin: 0, ageMax: 17, emoji: "🏛️", source: "nature", typicalHours: "Wed–Mon 9:30am–4:30pm (last admission) · Closed Tuesdays", seasonalNote: "Currently discounted to $20/adult while restoration is underway. Free Sunday Farmers Market at Vizcaya Village.", eventDate: null, daysOpen: [0,1,3,4,5,6], url: "https://vizcaya.org/welcome/" },
  { id: "venetianpool", lat: 25.7532, lng: -80.2666, name: "Venetian Pool", location: "2701 De Soto Blvd, Coral Gables", description: "The largest freshwater pool in the US — a 1924 historic landmark carved from a coral rock quarry with waterfalls, grottos, and a stone bridge. Spring-fed with 820,000 gallons of water refreshed daily. Kids must be at least 3 years old and 38 inches tall. You can bring your own food (no coolers, glass, or alcohol). Book in advance — closes at capacity. Closed Mondays.", setting: "outdoor", estimatedCost: "$17/non-resident · $6.75/CG resident (spring rates)", ageRange: "Ages 3+ (38\" min height)", ageMin: 3, ageMax: 17, emoji: "🏊", source: "nature", typicalHours: "Tue–Fri 11am–5:30pm · Sat–Sun 10am–4:30pm · Closed Mon", seasonalNote: "Current spring season: Mar 10 – May 24. Book online — capacity fills fast on weekends!", eventDate: null, daysOpen: [0,2,3,4,5,6], url: "https://www.coralgables.com/attractions/venetian-pool" },
  { id: "cgmuseum", lat: 25.7527, lng: -80.2596, name: "Coral Gables Museum", location: "285 Aragon Ave, Coral Gables", description: "Housed in the 1939 historic Police and Fire Station, the CG Museum explores architecture, urban design, and local history. Free Family Day on Aragon every 3rd Saturday (10am–6pm) with live music, arts & crafts, and kids activities. Bike tours and walking tours also originate here monthly.", setting: "indoor", estimatedCost: "Free on Family Day (3rd Sat) · Check site for other admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏗️", source: "events", typicalHours: "Wed–Sun — check site for hours · Family Day: 3rd Saturday 10am–6pm", seasonalNote: "Free Family Day on Aragon every 3rd Saturday — next one Apr 19.", eventDate: null, daysOpen: [0,3,4,5,6], url: "https://coralgablesmuseum.org" },
  { id: "matheson", lat: 25.67, lng: -80.2735, name: "Matheson Hammock Park & Atoll Pool", location: "9610 Old Cutler Rd, Coral Gables / Pinecrest", description: "630-acre urban park with a unique man-made atoll pool — a tidal lagoon flushed naturally by Biscayne Bay — plus a sandy beach, nature trails, kayaking, fishing pier, picnic pavilions, and the Noma Beach at Red Fish restaurant on the water. Perfect calm shallow water for young kids. Leashed pets not allowed in the park.", setting: "outdoor", estimatedCost: "$7 parking weekdays · $10 parking weekends", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌊", source: "nature", typicalHours: "Sunrise – Sunset daily", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.miamidade.gov/parks/matheson-hammock.asp" },
  { id: "kidsempire", lat: 25.7776, lng: -80.3754, name: "Kids Empire", location: "11401 NW 12th St #E610, Dolphin Mall, Miami (Sweetwater)", description: "Giant indoor playground at Dolphin Mall with multi-level climbing mazes, slides, spinning, a dedicated tots area for babies and toddlers, big Lego building stations, ball pit, mini soccer, and a snack bar. All-day access with re-entry. 2 adults enter free per child. Non-grip socks mandatory for everyone — $3 at the door or bring your own. Sign waiver online before arriving to skip the line.", setting: "indoor", estimatedCost: "$22.90/child (1–17) · 2 adults free · Infants free · 10-punch card $159", ageRange: "All ages (tots to age 12)", ageMin: 0, ageMax: 12, emoji: "🧗", source: "play", typicalHours: "Mon–Thu 10am–8pm · Fri–Sun & holidays 10am–10pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.kidsempire.com/park/miami" },
  { id: "velocityclimbing", lat: 25.7751, lng: -80.1948, name: "Velocity Climbing", location: "2280 NW 41st St, Miami, FL 33142 (near Wynwood / Earlington Heights)", description: "South Florida's largest indoor rock climbing facility — 23,000 sq ft with top rope walls up to 60ft, bouldering, auto belays (no partner needed), an Olympic-standard speed wall, Kilter board, and a full training area. Staff-led intro classes run every hour. Youth programs for ages 5–17. Family membership available. Day pass $30, gear rentals available. Kids under 18 must be accompanied by a parent. One block from Earlington Heights Metrorail — 5 min from Wynwood.", setting: "indoor", estimatedCost: "$30 day pass · Gear rental extra · Family membership from $89/parent + $50/child/mo", ageRange: "Ages 5+ (with parent)", ageMin: 5, ageMax: 17, emoji: "🧗", source: "play", typicalHours: "Mon/Wed/Fri 3–10pm · Tue/Thu 10am–10pm · Sat 9am–10pm · Sun 9am–8pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.velocityclimbing.com/" },
  // Miami-Dade Public Library — always-on resource card
  { id: "mdpls-fifa-lab", name: "FIFA 2026 Innovation Lab: Soccer & Science Discovery Day", location: "Kendale Lakes Branch — Miami-Dade Public Library", description: "A special event co-hosted by FIFA World Cup 2026 and Sports Konnect featuring a soccer and LEGO/robotics workshop. Kids learn about soccer and science together in a hands-on discovery day. Free — no library card required.", setting: "indoor", estimatedCost: "Free", ageRange: "Ages 6–16", ageMin: 6, ageMax: 16, emoji: "⚽", source: "arts", typicalHours: "Sat Apr 18, 1:30–3:30pm · Kendale Lakes Branch", seasonalNote: "Part of MDPLS's FIFA World Cup 2026 programming series", eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://mdpls.org/events" },
  { id: "library-tue", name: "📚 Library Tuesday — Storytime & STEM", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Tuesdays at MDPLS branches: Talking is Teaching bilingual storytime for babies & toddlers (ages 0–3, English/Spanish songs & stories); LEGO® Fun open play (ages 5–12, Main Library); Drop-in Game Time board games (ages 6–12); and YOUmake Miami STEAM open labs. All free, no library card needed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Programs vary 10am–4pm by branch — check mdpls.org/events", seasonalNote: null, eventDate: null, daysOpen: [2], url: "https://mdpls.org/events" },
  { id: "library-wed", name: "📚 Library Wednesday — Storytime & Crafts", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Wednesdays at MDPLS branches: READy Set Go storytelling (ages 0–5); Drop-in Game Time board games (ages 6–12, West Kendall); Earth Month storytelling in Spanish — Hora de los Cuentos (ages 3–8); and YOUmake Miami art & maker labs. All free, no library card needed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Programs vary 10am–4pm by branch — check mdpls.org/events", seasonalNote: null, eventDate: null, daysOpen: [3], url: "https://mdpls.org/events" },
  { id: "library-thu", name: "📚 Library Thursday — Toddler Storytime", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Thursdays at MDPLS branches: Talking is Teaching bilingual storytime for toddlers & preschoolers (ages 18mo–5, songs & activities); READy Set Go Music & Movement (ages 0–5, West Kendall); Drop-in Game Time chess & board games (ages 6–12). All free, no library card needed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Programs vary 10am–4pm by branch — check mdpls.org/events", seasonalNote: null, eventDate: null, daysOpen: [4], url: "https://mdpls.org/events" },
  { id: "library-fri", name: "📚 Library Friday — Family Drop-In Games & Storytime", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Fridays at MDPLS branches: Family Drop-in Game Time board games (ages 4–12, Main Library); Earth Day craft projects (ages 6–11); Talking is Teaching preschool storytime (ages 3–5). All free, no library card needed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Programs vary 10am–4pm by branch — check mdpls.org/events", seasonalNote: null, eventDate: null, daysOpen: [5], url: "https://mdpls.org/events" },
  { id: "library-sat", name: "📚 Library Saturday — Storytelling, Crafts & Tween Games", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Saturdays at MDPLS branches: READy Set Go Storytelling (ages 0–5, Westchester & Kendale Lakes); Tween Games — chess, checkers & board games (ages 8–12, Doral Branch 3pm); Take & Make Saturday craft kits to take home (ages 6–11, Hialeah Gardens); Family Storytime Earth Day edition (ages all). All free, no library card needed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Programs vary 10am–4pm by branch — check mdpls.org/events", seasonalNote: null, eventDate: null, daysOpen: [6], url: "https://mdpls.org/events" },
  { id: "library-sun", name: "📚 Library Sunday — Open Hours", location: "MDPLS branches countywide — find yours at mdpls.org", description: "Some MDPLS branches are open Sundays. Check mdpls.org/events for any Sunday programs at your nearest branch — programs vary and some branches are closed.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "arts", typicalHours: "Hours vary by branch — check mdpls.org", seasonalNote: null, eventDate: null, daysOpen: [0], url: "https://mdpls.org/events" },
  { id: "library-wildlife-apr18", name: "📚 Library Wildlife Show — Live Animal Encounter", location: "International Mall Branch — Miami-Dade Public Library", description: "Meet a variety of friendly live critters during a special presentation led by an experienced animal trainer, in partnership with the U.S. Army Garrison Miami. Free — no library card required.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🦎", source: "arts", typicalHours: "Sat Apr 18 · 1:00–2:00pm", seasonalNote: null, eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://mdpls.org/events" },
  { id: "library-therapy-dog", name: "📚 Library Therapy Dog Reading — Kendale Lakes", location: "Kendale Lakes Branch — Miami-Dade Public Library", description: "Read your favorite story aloud to a certified therapy dog! Reading to therapy dogs builds confidence and literacy skills in a pressure-free setting. Bring your own book or choose one from the library collection. Presented by Heel 2 Heal Therapy Dogs. Free, all ages.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🐕", source: "arts", typicalHours: "Check mdpls.org/branch-kendale-lakes for current schedule", seasonalNote: "A recurring Kendale Lakes favorite — check for upcoming dates!", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://mdpls.org/branch-kendale-lakes-regional" },
  { id: "skyzone", lat: 25.8183, lng: -80.3464, name: "Sky Zone Doral", location: "5450 NW 82nd Ave, Doral, FL 33166", description: "30,000+ sq ft indoor trampoline park with wall-to-wall trampolines, Ultimate Dodgeball, Foam Zone, Warrior Course, Sky Slam, Zip Line, and climbing walls. Little Leapers sessions for toddlers (Tue, Wed, Sun mornings). GLOW night sessions Fri/Sat evenings. Tuesday deal: all jump sessions $10. BOGO jump sessions available. Sign waiver online before arriving. Grip socks required — $3 at door.", setting: "indoor", estimatedCost: "Tickets from ~$20 · Tue all sessions $10 · Membership from $25.99/mo", ageRange: "All ages (Little Leapers for toddlers)", ageMin: 0, ageMax: 17, emoji: "🏀", source: "play", typicalHours: "Mon–Thu 3–9pm · Fri 3–7:30pm then 8–10pm · Sat 10am–10pm · Sun 12–9pm", seasonalNote: "Tuesday deal: all sessions just $10! GLOW sessions Fri & Sat evenings.", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.skyzone.com/doral/" },
  { id: "paradox", lat: 25.8024, lng: -80.2003, name: "Paradox Museum Miami", location: "2301 N Miami Ave, Wynwood, Miami", description: "70+ interactive optical illusion and paradox exhibits in the heart of Wynwood — walk on the ceiling in the Reverse Room, disappear in the Camouflage Wall, defy gravity in the Zero Gravity Room, and shrink or grow in the Ames Room. About 60–90 minutes. Florida resident discount available. Staff take photos for you. Sensory-Friendly Morning: Sat Apr 11, 9–11am.", setting: "indoor", estimatedCost: "~$24/child (4–11) · ~$30/adult · FL resident discount available", ageRange: "All ages (best ages 5+)", ageMin: 5, ageMax: 17, emoji: "🌀", source: "arts", typicalHours: "Mon–Thu 12–7pm · Fri 12–7pm · Sat 10am–9pm · Sun 10am–7pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://paradoxmuseum.com/miami/" },
  { id: "mbgarden", lat: 25.7946, lng: -80.1401, name: "Miami Beach Botanical Garden", location: "2000 Convention Center Drive, Miami Beach, FL 33139", description: "A free, lush 2.5-acre tropical garden in the heart of Miami Beach, steps from the convention center and a short walk from Lincoln Road. Features native and exotic plants, serene pathways, and peaceful shaded spots. Free general admission every day. Well-behaved leashed pets welcome. Kids under 12 must be with a guardian. Great combination with a Miami Beach day — free and calm counterpoint to the busy beach scene.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌺", source: "nature", typicalHours: "Tue–Sun 9am–5pm · Closed Mondays", seasonalNote: null, eventDate: null, daysOpen: [0,2,3,4,5,6], url: "https://www.mbgarden.org/" },
  { id: "palmettominigolf", lat: 25.7091, lng: -80.3289, name: "Palmetto Mini Golf", location: "9300 SW 152nd St, Miami, FL 33157 (Palmetto Golf Course)", description: "18-hole outdoor mini golf course on the grounds of the Miami-Dade County Palmetto Golf Course, featuring waterfalls, lagoons, and a cave amid lush tropical landscaping. One of Miami's most affordable and scenic mini golf spots — a real course, not a arcade gimmick. Birthday party packages available with on-site Sports Grill restaurant.", setting: "outdoor", estimatedCost: "$8/player Mon–Thu · $10/player Fri–Sun & holidays", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⛳", source: "nature", typicalHours: "Daily 10am–8pm (last tee 7:30pm)", seasonalNote: "Summer tip: call ahead (305-238-2922) as daytime camp field trips can book it out.", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.golfpalmetto.com/palmetto-mini-golf/" },
  // PAMM — Pérez Art Museum Miami
  { id: "pamm", lat: 25.7847, lng: -80.185, name: "Pérez Art Museum Miami (PAMM)", location: "1103 Biscayne Blvd, Museum Park, Downtown Miami", description: "World-class contemporary art museum on Biscayne Bay, designed by Herzog & de Meuron with stunning hanging gardens and waterfront terraces. Strong focus on Latin American, Caribbean, and African diaspora art. Free Second Saturdays every month (11am–3pm art-making + free all-day admission). MDCPS Student Pass = free admission any time + 1 free adult guest. Under 7 always free. Bank of America cardholders free first weekend of the month.", setting: "indoor", estimatedCost: "$18/adult · $12/child (7–18) · Under 7 free · Free on Second Saturdays", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎨", source: "arts", typicalHours: "Mon 11am–6pm · Tue–Wed Closed · Thu 11am–9pm · Fri–Sun 11am–6pm", seasonalNote: "Free Second Saturdays: next is Apr 11 (Sports & Trophy-making theme, Miami Heat & Marlins appearances).", eventDate: null, daysOpen: [0,1,4,5,6], url: "https://www.pamm.org/en/visit/" },
  { id: "pamm-second-sat-apr", lat: 25.7847, lng: -80.185, name: "PAMM Free Second Saturday — Get in the Game!", location: "Pérez Art Museum Miami, 1103 Biscayne Blvd, Museum Park", description: "Free all-day admission with art-making 11am–3pm. April theme: sports and personal achievement. Features Miami Heat and Marlins appearances, performances by the Legacy Percussion Ensemble, and hands-on trophy-making and art activities for families. Free, no tickets needed.", setting: "indoor", estimatedCost: "Free all day", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏆", source: "arts", typicalHours: "11am–3pm (art activities) · Museum open until 6pm", seasonalNote: "Free! Miami Heat + Marlins appearances · Legacy Percussion Ensemble performance.", eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://www.pamm.org/en/events/event/pamm-free-second-saturdays-get-in-the-game/" },
  { id: "pamm-kids-jamm", lat: 25.7847, lng: -80.185, name: "KIDS JAMM at PAMM", location: "Pérez Art Museum Miami, 1103 Biscayne Blvd, Museum Park", description: "PAMM's premier family fundraiser — a morning of hands-on art-making, live performances, and gallery exploration for kids and families. Designed to spark creativity and connect children to the art community. Tickets required for this special event.", setting: "indoor", estimatedCost: "Ticketed — check pamm.org", ageRange: "All ages (family event)", ageMin: 0, ageMax: 17, emoji: "🎭", source: "arts", typicalHours: "10am–1pm", seasonalNote: null, eventDate: "Sun Apr 19, 2026", daysOpen: [0], url: "https://www.pamm.org/en/events/event/kids-jamm-at-pamm-2/" },
  { id: "pamm-storytime-apr", lat: 25.7847, lng: -80.185, name: "PAMM Storytime", location: "Pérez Art Museum Miami, 1103 Biscayne Blvd, Museum Park", description: "A family-friendly museum program introducing young children to art, storytelling, and hands-on creativity. Part of PAMM's regular monthly Storytime series. Included with admission or free on Second Saturdays.", setting: "indoor", estimatedCost: "Included with admission · Free on Second Saturdays", ageRange: "Young children (ages 3–7)", ageMin: 3, ageMax: 7, emoji: "📖", source: "arts", typicalHours: "Check pamm.org for exact time", seasonalNote: null, eventDate: "Sat Apr 25, 2026", daysOpen: [6], url: "https://www.pamm.org/en/events/?event_cat=12926" },
  // Homestead-Miami Speedway
  { id: "speedway", lat: 25.4531, lng: -80.4071, name: "Homestead-Miami Speedway", location: "1 Speedway Blvd, Homestead, FL 33035", description: "A 650-acre motorsports complex in South Dade with a 1.5-mile oval and 2.21-mile road course. Home to the 2026 NASCAR Championship Weekend (Nov 6–8) — the season finale for all three NASCAR national series, returning after a 6-year hiatus. Also hosts Fast Lane Friday street-legal drag racing, NASCAR Race Car Ride Alongs, and the Beach Bash infield area on the 7-acre spring-fed lake (open to all ages). Kids tickets often deeply discounted or free with adult purchase.", setting: "outdoor", estimatedCost: "Varies by event · NASCAR Championship from ~$30+ · Fast Lane Friday spectators free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏎️", source: "sports", typicalHours: "Event-dependent — check homesteadmiamispeedway.com/calendar", seasonalNote: "2026 NASCAR Championship Weekend returns Nov 6–8 — first time since 2019!", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.homesteadmiamispeedway.com/calendar/" },
  { id: "speedway-nascar-champ", lat: 25.4531, lng: -80.4071, name: "NASCAR Championship Weekend", location: "Homestead-Miami Speedway, 1 Speedway Blvd, Homestead", description: "The 2026 NASCAR season finale returns to Homestead for the first time since 2019 — three days of championship racing across all three NASCAR national series. Fri Nov 6: Craftsman Truck Series Championship. Sat Nov 7: O'Reilly Auto Parts Series Championship. Sun Nov 8: NASCAR Cup Series Championship. Kids FREE on Saturday in General Admission ($10 reserved). Youth and Family activities, NASCAR Experience stage with driver appearances. Beach Bash open all ages on the infield lake.", setting: "outdoor", estimatedCost: "From ~$30 · Kids FREE (Sat GA) or $10 (Sat reserved) with adult ticket", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏆", source: "sports", typicalHours: "Fri Nov 6 7pm · Sat Nov 7 · Sun Nov 8", seasonalNote: "Kids FREE Saturday in General Admission — historic Championship Weekend back in Miami!", eventDate: "Nov 6 – 8, 2026", daysOpen: [5,6,0], url: "https://www.homesteadmiamispeedway.com/events/champ/" },
  { id: "speedway-fastlane", lat: 25.4531, lng: -80.4071, name: "Fast Lane Friday — Spectator Night", location: "Homestead-Miami Speedway, 1 Speedway Blvd, Homestead", description: "Watch street-legal cars drag race head-to-head on the actual NASCAR track straightaway. Spectators watch free — drivers pay $50/car for 6 laps. Great motorsports experience for kids who love fast cars, held monthly Friday evenings. Not suitable for young toddlers due to noise and late hours.", setting: "outdoor", estimatedCost: "Free for spectators · $50/car for participants (18+ to drive)", ageRange: "Ages 5+ (loud, late)", ageMin: 5, ageMax: 17, emoji: "🚗", source: "sports", typicalHours: "Friday evenings — check homesteadmiamispeedway.com for dates", seasonalNote: "Spectators watch free! Monthly Friday nights Apr–Sep.", eventDate: null, daysOpen: [5], url: "https://www.homesteadmiamispeedway.com/fast-lane-friday/" },
  { id: "goldcoastrailroad", lat: 25.658, lng: -80.4086, name: "Gold Coast Railroad Museum", location: "12450 SW 152nd St, Miami (near Zoo Miami)", description: "One of Florida's three official State Railroad Museums — 40+ historic railcars on 3 miles of track, including the Presidential railcar Ferdinand Magellan (used by FDR, Truman, and Eisenhower) and a WWII-era steam locomotive. Rides available: Link train (2-ft narrow gauge, weekdays 12pm), Standard Gauge, Cab Rides, and Speeder rides. Thomas play tables, model train room, and WWII airship base exhibits. Call ahead to confirm ride availability. Military free · EBT/WIC Museums4All $3 for up to 4.", setting: "outdoor", estimatedCost: "$10/child (3–12) · $12/adult · Under 3 free · Seniors $8", ageRange: "All ages (train-lovers!)", ageMin: 0, ageMax: 17, emoji: "🚂", source: "nature", typicalHours: "Wed–Fri 11am–4pm · Sat–Sun 10am–4pm · Closed Mon–Tue", seasonalNote: null, eventDate: null, daysOpen: [0,3,4,5,6], url: "https://www.goldcoastrailroadmuseum.org" },
  { id: "potterymiami", lat: 25.762, lng: -80.1935, name: "Pottery Miami — Kids Pottery Classes", location: "164 NW 20th St, Miami 33127 (Wynwood) · 701 NW 2nd Ave (Edgewater)", description: "Hands-on pottery and hand-building classes for kids from age 3, taught by experienced instructors. In a 2-hour session kids shape clay into mugs, bowls, vases, and more using a potter's wheel and hand-building techniques — finished piece goes home after firing (2–3 weeks). No experience needed, no enrollment fee, no commitment. Also offers kids birthday parties and school field trips. Book at pottery-miami.com.", setting: "indoor", estimatedCost: "$90/person (hand-building); $130 with painting/glazing", ageRange: "Ages 3+", ageMin: 3, ageMax: 17, emoji: "🏺", source: "arts", typicalHours: "Daily 10am–9pm, 2-hour sessions", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://pottery-miami.com/kids-pottery-classes-in-miami" },
  { id: "skatebird", lat: 25.8533, lng: -80.172, name: "SkateBird Miami", location: "533 NE 83rd St, Miami 33138 (Upper Eastside / El Portal)", description: "32,000 sq ft skatepark complex featuring a covered 12,000 sq ft skate plaza and an outdoor 18,000 sq ft pump track — built to handle rain and open late. Classes, private lessons, and seasonal skate camps for all skill levels. Beyond skating: DJ Academy, gaming lounge, food (pizza, burgers, Mediterranean), skate shop, and regular community events. Rentals available (skateboards, scooters, pads). Also the host venue for Tutifruti's Falling Frut workshop on Apr 17. Monday is FREE SKATE day.", setting: "outdoor", estimatedCost: "$10 entry / $8 rentals; FREE Mondays. Lessons from $25 trial class", ageRange: "All ages", ageMin: 3, ageMax: 17, emoji: "🛹", source: "play", typicalHours: "Mon–Fri 12–8pm · Sat 10am–6pm · Sun 10am–7pm", seasonalNote: "Spring, Summer & Winter skate camps available — book at active.com/orgs/skatebird-miami", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.skatebirdmiami.com" },
  { id: "crowjiujitsu", lat: 25.7823, lng: -80.2079, name: "Crow Jiu Jitsu — Kids & Youth Classes", location: "South Miami: 5958 S Dixie Hwy · Pinecrest: crowjiujitsu.com/pinecrest", description: "Brazilian jiu-jitsu academy with dedicated kids and youth programs at two South Miami-area locations. Toddlers (ages 3–5) and Kids (ages 6–9) classes build self-confidence, discipline, social skills, and foundational BJJ technique. Youth program (ages 10+) adds coordination, movement, and self-defense. Private lessons also available. Free trial class — book online at crowjiujitsu.com.", setting: "indoor", estimatedCost: "Free trial class · Membership pricing — contact academy", ageRange: "Ages 3+", ageMin: 3, ageMax: 17, emoji: "🥋", source: "play", typicalHours: "Check crowjiujitsu.com for class schedule by location", seasonalNote: "Free trial class available — no commitment needed to try it!", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.crowjiujitsu.com/programs" },
  // Tutifruti
  { id: "tutifruti", lat: 25.7995, lng: -80.2052, name: "Tutifruti — Movement & Art Workshops", location: "Various locations across Miami-Dade, Broward & Palm Beach", description: "South Florida nonprofit bringing low-cost, inclusive movement and creative art workshops to communities across the region. Programs include skateboarding, yoga, art workshops (screenprinting, bookmaking, block printing, fingerboard-making), and mental health discussions. Welcoming to all — especially women, girls, BIPOC, and LGBTQ+ youth. Check Instagram @tutifruti.fl for upcoming workshops.", setting: "outdoor", estimatedCost: "Low cost or free", ageRange: "Ages 5+", ageMin: 5, ageMax: 17, emoji: "🛹", source: "arts", typicalHours: "Varies by event — check tutifruti-fl.org", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.tutifruti-fl.org" },
  { id: "tutifruti-falling-frut", lat: 25.7995, lng: -80.2052, name: "Tutifruti: Falling Frut Workshop @ Skatebird Miami", location: "Skatebird Miami (check miamiandbeaches.com for exact address)", description: "A movement and poetry workshop led by Tutifruti reimagining the skatepark as a space for guided physical practice and creative reflection. Participants move through the space, explore a falling clinic (without gear), observe their physical and emotional responses, then write poetry. Part of the O, Miami Poetry Festival. Ages 5+, parental supervision for younger kids.", setting: "outdoor", estimatedCost: "Free or low cost — check site", ageRange: "Ages 5+", ageMin: 5, ageMax: 17, emoji: "🛹", source: "arts", typicalHours: "Friday April 17", seasonalNote: "Part of the O, Miami Poetry Festival — combining skateboarding, falling, and poetry!", eventDate: "Fri Apr 17, 2026", daysOpen: [5], url: "https://www.tutifruti-fl.org" },
  { id: "pottery-miami", lat: 25.762, lng: -80.1935, name: "Pottery Studio Miami — Kids Classes", location: "164 NW 20th St, Miami, FL 33127 (Wynwood / Edgewater area)", description: "Daily pottery, hand-building, and painting classes for kids and families in a drop-in-friendly studio near Wynwood. No experience needed, no membership required. Classes run 2 hours with an instructor guiding every step. Kids take home a finished piece after firing (2–3 weeks). Mommy & Me (ages 3–5): $90 total for parent + child. Kids Ceramics (ages 6–10): $90/person (hand-building + 1 firing) or $130 with painting, glazing + 2 firings. Teens same pricing. Private family groups up to 20 people ($100/person, $500 min).", setting: "indoor", estimatedCost: "$90 total Mommy & Me (3–5) · $90/person kids (6–10) · $130 with painting", ageRange: "Ages 3+", ageMin: 3, ageMax: 17, emoji: "🏺", source: "arts", typicalHours: "Mon–Fri 12–10pm · Sat–Sun 10am–10pm · Classes every 2 hrs, book online", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://pottery-miami.com/kids-pottery-classes-in-miami" },
  { id: "aki-festival-2026", lat: 25.5755, lng: -80.4431, name: "AKI Family Arts Festival 2026 — All Kids Included", location: "Dennis C. Moss Cultural Arts Center · 9901 SW 186th St, Cutler Bay 33157", description: "The 20th annual All Kids Included (AKI) Family Arts Festival — a free, fully inclusive day of creativity and community for children of all abilities and their families. Features live music and theater performances, hands-on arts activities, a rock-climbing wall, outdoor games, and community resource tables. Full accessibility accommodations: Braille, sighted guides, audio description, sensory-inclusive programs, and shadow-interpreted theatre. Presented by Miami-Dade County Department of Cultural Affairs.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎨", source: "events", typicalHours: "Sat May 2 · 10am (check mosscenter.org for exact hours)", seasonalNote: "Fully sensory-inclusive and accessibility-forward — great for kids with and without disabilities.", eventDate: "Sat May 2, 2026", daysOpen: [6], url: "https://www.mosscenter.org/mc/eventDetail.page?id=379" },
  { id: "fifa-fan-festival", lat: 25.7742, lng: -80.187, name: "FIFA Fan Festival™ Miami — Bayfront Park", location: "Bayfront Park, 301 Biscayne Blvd, Downtown Miami", description: "The official FIFA World Cup 26™ Fan Festival — free and open to everyone, no match ticket needed. Set on Biscayne Bay at Bayfront Park, the festival features live match broadcasts on big screens, entertainment, cultural performances, food, games, and interactive fan experiences. Miami's 2026 World Cup matches are played nearby at Hard Rock Stadium. A once-in-a-generation event for soccer-loving families.", setting: "outdoor", estimatedCost: "Free entry", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏆", source: "events", typicalHours: "Jun 13 – Jul 5 · Daily hours TBA — check miamifwc26.com/fan-festival", seasonalNote: "Free! No match ticket needed. Miami hosts World Cup matches Jun–Jul 2026 — the Fan Festival is for everyone.", eventDate: "Jun 13 – Jul 5, 2026", daysOpen: [0,1,2,3,4,5,6], url: "https://miamifwc26.com/fan-festival/" },
  // Baller League (weekly Thursdays Apr-May at Tropical Park)
  { id: "ballerleague-apr16", lat: 25.7374, lng: -80.3456, name: "⚽ Baller League USA — Matchday 5", location: "Baller League Arena, Tropical Park · 7900 SW 40th St, Miami 33155", description: "High-speed 6v6 indoor soccer with celebrity-managed teams including Ronaldinho, Usain Bolt, iShowSpeed, Odell Beckham Jr., J Balvin, and Druski. 5 matches per night, gates open 4:30pm, matches 5:15–10pm. Loud, fast, and built for the digital generation — scored on CBS Sports Golazo Network.", setting: "indoor", estimatedCost: "Tickets from ~$25 — check feverup.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "sports", typicalHours: "Gates 4:30pm · Matches 5:15–10:00pm", seasonalNote: "Ronaldinho, Usain Bolt, iShowSpeed, OBJ & more manage teams!", eventDate: "Thu Apr 16, 2026", daysOpen: [4], url: "https://ballerleague.us/en" },
  { id: "ballerleague-apr23", lat: 25.7374, lng: -80.3456, name: "⚽ Baller League USA — Matchday 6", location: "Baller League Arena, Tropical Park · 7900 SW 40th St, Miami 33155", description: "High-speed 6v6 indoor soccer. 5 matches per night featuring all 10 celebrity-managed teams. Gates 4:30pm, matches 5:15–10pm.", setting: "indoor", estimatedCost: "Tickets from ~$25 — check feverup.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "sports", typicalHours: "Gates 4:30pm · Matches 5:15–10:00pm", seasonalNote: null, eventDate: "Thu Apr 23, 2026", daysOpen: [4], url: "https://ballerleague.us/en" },
  { id: "ballerleague-apr30", lat: 25.7374, lng: -80.3456, name: "⚽ Baller League USA — Matchday 7", location: "Baller League Arena, Tropical Park · 7900 SW 40th St, Miami 33155", description: "High-speed 6v6 indoor soccer. 5 matches per night featuring all 10 celebrity-managed teams. Gates 4:30pm, matches 5:15–10pm.", setting: "indoor", estimatedCost: "Tickets from ~$25 — check feverup.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "sports", typicalHours: "Gates 4:30pm · Matches 5:15–10:00pm", seasonalNote: null, eventDate: "Thu Apr 30, 2026", daysOpen: [4], url: "https://ballerleague.us/en" },
  { id: "ballerleague-may7", lat: 25.7374, lng: -80.3456, name: "⚽ Baller League USA — Matchday 8", location: "Baller League Arena, Tropical Park · 7900 SW 40th St, Miami 33155", description: "High-speed 6v6 indoor soccer. 5 matches per night featuring all 10 celebrity-managed teams. Gates 4:30pm, matches 5:15–10pm.", setting: "indoor", estimatedCost: "Tickets from ~$25 — check feverup.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "sports", typicalHours: "Gates 4:30pm · Matches 5:15–10:00pm", seasonalNote: null, eventDate: "Thu May 7, 2026", daysOpen: [4], url: "https://ballerleague.us/en" },
  { id: "ballerleague-may14", lat: 25.7374, lng: -80.3456, name: "⚽ Baller League USA — Matchday 9", location: "Baller League Arena, Tropical Park · 7900 SW 40th St, Miami 33155", description: "High-speed 6v6 indoor soccer. 5 matches per night featuring all 10 celebrity-managed teams. Gates 4:30pm, matches 5:15–10pm.", setting: "indoor", estimatedCost: "Tickets from ~$25 — check feverup.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "sports", typicalHours: "Gates 4:30pm · Matches 5:15–10:00pm", seasonalNote: "Final regular season matchday before playoffs!", eventDate: "Thu May 14, 2026", daysOpen: [4], url: "https://ballerleague.us/en" },
  // GOOOOO Miami — World Cup watch party
  { id: "gooooo-miami", lat: 25.7617, lng: -80.1918, name: "GOOOOO, Miami! — World Cup Watch Party Festival", location: "Check eventbrite.com for exact venue", description: "A World Cup celebration event in Miami featuring live match watching, entertainment, food, and festivities. Part of Miami's FIFA World Cup 2026 season of events.", setting: "outdoor", estimatedCost: "Check eventbrite.com for ticket price", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌍", source: "events", typicalHours: "Sat Apr 18 · 12pm–3pm", seasonalNote: "Part of Miami's World Cup 2026 celebration season!", eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://www.eventbrite.com/e/gooooo-miami-tickets-1986048489495" },
  // McLaren Racing Live
  { id: "mclaren-racing-live", lat: 25.7892, lng: -80.1397, name: "McLaren Racing Live: Miami — Free F1 Fan Experience", location: "Regatta Harbour, Miami · (Apr 29 – May 3)", description: "McLaren's biggest-ever fan event in the US, celebrating their 1,000th Grand Prix milestone. Free to attend at Regatta Harbour across 5 days during F1 race weekend. Features historic McLaren race cars, the 2025 Constructors' Trophy, race simulators, artwork, giant live screens showing every F1 session, and immersive partner activations. Great for kids who love racing — no circuit ticket needed.", setting: "outdoor", estimatedCost: "Free entry", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🧡", source: "events", typicalHours: "Wed Apr 29 – Sun May 3 · Hours TBA closer to event", seasonalNote: "Free! McLaren celebrates their 1,000th Grand Prix — historic milestone.", eventDate: "Apr 29 – May 3, 2026", daysOpen: [0,3,4,5,6], url: "https://www.mclaren.com/racing/mclaren-racing-live-miami/" },
  // Soul Rodeo
  { id: "soul-rodeo-homestead", lat: 25.4778, lng: -80.4603, name: "South Florida Soul Rodeo — Homestead", location: "Harris Field Doc De Milly Rodeo Grounds, Homestead, FL", description: "A community celebration blending Southern-style rodeo competition with live music, food, and family fun. Features bull riding, ladies barrel racing, ranch bronc riding, chute dogging, and junior barrel racing. Hosted by T.D.O.G.G.'s Bigg Dreams Charity with a community-oriented twist. Sponsored by 99 JAMZ.", setting: "outdoor", estimatedCost: "Tickets from ~$25 — check eventbrite.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🤠", source: "events", typicalHours: "Sat May 9 · 5:00–10:00pm", seasonalNote: "Live music, food trucks, bull riding & barrel racing — something for everyone!", eventDate: "Sat May 9, 2026", daysOpen: [6], url: "https://www.eventbrite.com/e/south-florida-soul-rodeo-homestead-tickets-1816638678189" },
  // Miami Beach Polo World Cup
  { id: "miami-beach-polo", lat: 25.7944, lng: -80.13, name: "Miami Beach Polo World Cup 2026 — Free to Watch!", location: "Collins Park Beach, 21st–22nd St & Collins Ave, Miami Beach", description: "The world's largest beach polo event returns to the sands of Miami Beach. 8 international teams, 120+ horses, and 3 days of thrilling matches right on the Atlantic Ocean. General admission is completely free — just walk up to the padded barrier and watch. VIP and lounge tickets also available. Celebrity appearances, après polo parties at The Setai, and a vibrant social scene all weekend.", setting: "outdoor", estimatedCost: "Free general admission · VIP lounge from ~$88/day", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏇", source: "events", typicalHours: "Thu Nov 12 – Sun Nov 15 · Matches from 1pm daily", seasonalNote: "Free to watch on the beach! One of the most spectacular free spectator events in Miami.", eventDate: "Nov 12 – 15, 2026", daysOpen: [4,5,6,0], url: "https://miamibeachpolo.com/" },
  // Orange Blossom Classic
  { id: "orange-blossom-classic", lat: 25.9581, lng: -80.2389, name: "Orange Blossom Classic 2026 — HBCU Football at Hard Rock", location: "Hard Rock Stadium, 347 Don Shula Dr, Miami Gardens", description: "The 52nd Orange Blossom Classic — one of HBCU football's most iconic events — returns to Hard Rock Stadium on Labor Day weekend. South Carolina State Bulldogs (defending HBCU national champions) vs. Florida A&M Rattlers. Full week of cultural events, halftime band showcase, community programs, and pregame festivities. One of the most electric atmospheres in college football.", setting: "outdoor", estimatedCost: "Tickets from ~$30+ — check ticketmaster.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏈", source: "events", typicalHours: "Sun Sep 6 · 1:00pm kickoff", seasonalNote: "HBCU football's biggest stage — defending national champs SCSU vs. FAMU!", eventDate: "Sun Sep 6, 2026", daysOpen: [0], url: "https://www.orangeblossomclassic.com/" },
  // Pinecrest Gardens events
  { id: "pinecrest-pno-apr11", lat: 25.6676, lng: -80.3002, name: "Pinecrest Gardens: Parents Night Out with Discovery Lab", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "Drop off your junior scientist (ages 4–9) for an evening of science and art activities while you enjoy a night out. Kids explore STEAM education principles and discover nature at night at Pinecrest Gardens.", setting: "outdoor", estimatedCost: "Check pinecrestgardens.org for pricing", ageRange: "Ages 4–9", ageMin: 4, ageMax: 9, emoji: "🔬", source: "nature", typicalHours: "Sat Apr 11 · 6:00–10:00pm", seasonalNote: "Drop-off evening — perfect parents night out!", eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://www.pinecrestgardens.org/Learn/Youth-Family-Programs/Parents-Night-Out" },
  { id: "pinecrest-bookfair-apr11", lat: 25.6676, lng: -80.3002, name: "Pinecrest Gardens: Friends of the Library Book Club Fair", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "A lively celebration of books and readers at Pinecrest Gardens, bringing together bestselling authors, book clubs, and literary enthusiasts. Family-friendly event with book sales and author appearances.", setting: "outdoor", estimatedCost: "Free entry (garden admission applies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "nature", typicalHours: "Sat Apr 11 · 10:00am–3:00pm", seasonalNote: null, eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://www.pinecrestgardens.org/Events-directory" },
  { id: "pinecrest-nudeco-apr18", lat: 25.6676, lng: -80.3002, name: "Pinecrest Gardens: Jazz Finale — Nu Deco Ensemble", location: "Banyan Bowl, Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "Season finale of the Jazz at Pinecrest Gardens series featuring Nu Deco Ensemble — Miami's genre-defying hybrid orchestra. Performing jazz suites celebrating Nina Simone and Duke Ellington, reimagined through a dynamic contemporary lens. Outdoor Banyan Bowl amphitheater under the geodesic dome.", setting: "outdoor", estimatedCost: "Check pinecrestgardens.org for ticket price", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎷", source: "nature", typicalHours: "Sat Apr 18 · 8:00pm", seasonalNote: "Jazz season finale — Nina Simone & Duke Ellington reimagined by Miami's Nu Deco!", eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://www.pinecrestgardens.org/Arts-Events/Performing-Arts/Jazz-at-Pinecrest-Gardens" },
  { id: "pinecrest-farmers-market", lat: 25.6676, lng: -80.3002, name: "Pinecrest Gardens Sunday Farmers Market", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "One of South Florida's longstanding community markets, held every Sunday at Pinecrest Gardens. Fresh local produce, artisan goods, food vendors, and the beautiful botanical garden as a backdrop. Free to browse.", setting: "outdoor", estimatedCost: "Free to browse", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🥦", source: "nature", typicalHours: "Sundays · Check pinecrestgardens.org for times", seasonalNote: null, eventDate: null, daysOpen: [0], url: "https://www.pinecrestgardens.org/Events-directory" },
  { id: "pinecrest-art-exhibition", lat: 25.6676, lng: -80.3002, name: "Pinecrest Gardens: Art, Design & Architecture in Nature", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "Spring exhibition curated by Hartvest Project and Doral Contemporary Art Museum. Art, design, and architecture works displayed across the lush botanical gardens — a unique outdoor gallery experience. On view through May 31.", setting: "outdoor", estimatedCost: "Included with garden admission ($5/person)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🖼️", source: "nature", typicalHours: "Daily 9am–5pm through May 31, 2026", seasonalNote: "Art installations throughout the garden — Mar 15 – May 31.", eventDate: "Mar 15 – May 31, 2026", daysOpen: [0,1,2,3,4,5,6], url: "https://www.pinecrestgardens.org/Arts-Events/Visual-Arts/Temporary-Exhibitions" },
  { id: "pinecrest-lizards-apr15", lat: 25.6676, lng: -80.3002, name: "Little Lizards: Pollinators", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "Drop-in garden program for children ages 4–9. Learn about pollinators — wind, people, butterflies, bees and bats — and the fascinating process of plant reproduction. Get up close and personal with some of the Garden's favorite pollinators. Advance registration required.", setting: "outdoor", estimatedCost: "Check pinecrestgardens.org for pricing", ageRange: "Ages 4–9", ageMin: 4, ageMax: 9, emoji: "🐝", source: "nature", typicalHours: "Wed Apr 15 · 2:00–3:00pm", seasonalNote: "Advance registration required!", eventDate: "Wed Apr 15, 2026", daysOpen: [3], url: "https://www.pinecrestgardens.org/Arts-Events/Events-Calendar/4.15.26.Little-Lizards-Pollinators" },
  { id: "pinecrest-orchestra-apr19", lat: 25.6676, lng: -80.3002, name: "Orchestra Miami: Poetry in Music", location: "Banyan Bowl, Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "50-piece Orchestra Miami performs an evening of symphonic poems: Scheherazade by Rimsky-Korsakov (the tale of the Persian queen from One Thousand and One Nights), Four Walt Whitman Songs (baritone Kyle Pfortmiller), and Holst's Walt Whitman Overture. Conducted by Artistic Director Elaine Rinaldi. Outdoor Banyan Bowl amphitheater.", setting: "outdoor", estimatedCost: "$44.43 — tickets at humanitix.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎻", source: "nature", typicalHours: "Sun Apr 19 · 6:00–8:00pm", seasonalNote: "Scheherazade under the stars in the Banyan Bowl — a magical evening!", eventDate: "Sun Apr 19, 2026", daysOpen: [0], url: "https://www.pinecrestgardens.org/Arts-Events/Events-Calendar/4.19.26.Orchestra-Miami-presents-A-Classical-Series-Poetry-in-Music" },
  { id: "pinecrest-romeo-juliet", lat: 25.6676, lng: -80.3002, name: "Romeo & Juliet — Dance Performance", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "A dance performance of Shakespeare's Romeo & Juliet at Pinecrest Gardens' beautiful outdoor venue. Two-night run.", setting: "outdoor", estimatedCost: "Check pinecrestgardens.org for pricing", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🩰", source: "nature", typicalHours: "Fri Apr 24 – Sat Apr 25", seasonalNote: null, eventDate: "Apr 24 – 25, 2026", daysOpen: [5,6], url: "https://www.pinecrestgardens.org/Arts-Events/Events-Calendar/4.244.25.2026.Romeo-Juliet" },
  { id: "pinecrest-lizards-apr29", lat: 25.6676, lng: -80.3002, name: "Little Lizards: Pollinators", location: "Pinecrest Gardens · 11000 Red Rd, Pinecrest", description: "Drop-in garden program for children ages 4–9. Learn about pollinators — wind, people, butterflies, bees and bats — and the fascinating process of plant reproduction. Get up close and personal with some of the Garden's favorite pollinators. Advance registration required.", setting: "outdoor", estimatedCost: "Check pinecrestgardens.org for pricing", ageRange: "Ages 4–9", ageMin: 4, ageMax: 9, emoji: "🐝", source: "nature", typicalHours: "Wed Apr 29 · 2:00–3:00pm", seasonalNote: "Advance registration required!", eventDate: "Wed Apr 29, 2026", daysOpen: [3], url: "https://www.pinecrestgardens.org/Arts-Events/Events-Calendar/4.29.26.Little-Lizards-Pollinators" },
  { id: "england-costa-rica-jun10", lat: 28.542, lng: -81.3832, name: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England vs Costa Rica — Pre-World Cup Friendly", location: "Inter&Co Stadium, Orlando · 1 Exploria Blvd, Orlando FL (1hr drive from Miami)", description: "England men's national team faces Costa Rica in a World Cup warm-up friendly — the first England game on U.S. soil in over 20 years. Part of England's South Florida preparation camp before their World Cup base in Kansas City. Thomas Tuchel's squad (including England's World Cup group: Croatia, Ghana, Panama) plays under the lights at Inter&Co Stadium in downtown Orlando. Day trip from Miami — about 1 hour by car.", setting: "outdoor", estimatedCost: "Tickets TBA — check orlandocitysc.com (general sale from Apr 16)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚽", source: "events", typicalHours: "Wed Jun 10 · 4:00pm ET kickoff", seasonalNote: "🌍 England's first game on US soil in 20+ years — rare chance to see the Three Lions live!", eventDate: "Wed Jun 10, 2026", daysOpen: [3], url: "https://www.orlandocitysc.com/news/inter-co-stadium-set-to-host-england-in-pre-world-cup-match-against-costa-rica-on-june-10" },
  { id: "jellyfish-museum", lat: 26.2284, lng: -80.0997, name: "Jellyfish Museum — America's First", location: "199 N Ocean Blvd, Pompano Beach FL (45 min from Miami)", description: "The first jellyfish museum in the United States — a one-of-a-kind immersive experience blending science, art and storytelling. Explore 21+ species of jellyfish from oceans worldwide in custom-designed tanks, plus a 5-meter-high 3D projection room where you're surrounded by drifting jellyfish and deep-sea visuals. Meditative, educational, and visually stunning. Opened March 2026. Kids 0–2 free. Walk across the street to Pompano Beach pier and waterfront dining after.", setting: "indoor", estimatedCost: "~$21–$26/person · Under 2 free — check jellyfish-museum.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🪼", source: "arts", typicalHours: "Check jellyfish-museum.com for hours", seasonalNote: "America's first jellyfish museum — just opened March 2026! A day trip worth making.", eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.jellyfish-museum.com/" },
  { id: "elmos-got-the-moves", lat: 25.7897, lng: -80.1920, name: "Sesame Street Live: Elmo's Got the Moves!", location: "Adrienne Arsht Center — Ziff Ballet Opera House, 1300 Biscayne Blvd, Miami", description: "The all-new Sesame Street Live show! Elmo, Abby Cadabby, Cookie Monster and friends take the stage at the Arsht Center for a joyful, interactive performance of singing, dancing and movement. Kids and parents dance along to Sunny Days, Letter of the Day, and Elmo's Got the Moves. Yoga, jumping rope, cartwheeling and silly dancing — all in a welcoming, colorful show. Photo experience with characters available as an add-on. Flashing lights and confetti — heads up for sensory-sensitive kids.", setting: "indoor", estimatedCost: "Tickets from ~$34.50 — check arshtcenter.org · Photo experience add-on ~$46", ageRange: "Ages 2+ (under 2: lap ticket $15)", ageMin: 0, ageMax: 10, emoji: "🎭", source: "arts", typicalHours: "Sat Apr 25 · 4:00pm", seasonalNote: "Elmo live on stage! Photo experience with characters available as an add-on.", eventDate: "Sat Apr 25, 2026", daysOpen: [6], url: "https://www.arshtcenter.org/tickets/2025-2026/family-fun-live/elmos-got-the-moves/" },
  { id: "bass-museum", lat: 25.7944, lng: -80.1305, name: "The Bass — Miami Beach Contemporary Art Museum", location: "2100 Collins Ave, Collins Park, Miami Beach", description: "Miami Beach's contemporary art museum in a stunning 1930s Art Deco building steps from the beach. Focuses on international contemporary art across painting, sculpture, design, fashion and architecture. Current exhibitions include Jack Pierson: The Miami Years (through Aug 16) and Lawrence Lek: NOX Pavilion AI installation. Outdoor public art in Collins Park including Ugo Rondinone's iconic Miami Mountain — five fluorescent boulders stacked 42 feet high. Kids 6 and under always free. Self-guided tour via QR codes or free Bloomberg Connects app. Free bus on Family Days from Little Havana and Little Haiti.", setting: "indoor", estimatedCost: "$15/adult · $8/youth (7–18), students & seniors · Under 6 free · Free last Sunday (Family Day) · Free 3rd Thursday 6–9pm · MB/Surfside residents free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎨", source: "arts", typicalHours: "Wed–Sun 12–6pm · Closed Mon & Tue", seasonalNote: "Free Family Day last Sunday each month (2–4pm art-making). Free Third Thursdays 6–9pm. Bank of America cardholders free first weekend of the month.", eventDate: null, daysOpen: [0,3,4,5,6], url: "https://thebass.org/plan-your-visit/" },
  { id: "bass-family-day", lat: 25.7944, lng: -80.1305, name: "The Bass — Free Family Day", location: "2100 Collins Ave, Collins Park, Miami Beach", description: "Free admission and art-making activities for kids and caregivers on the last Sunday of every month. Art projects, scavenger hunts and hands-on creativity sessions run 2–4pm. Free Bass Bus picks up from Little Havana, Little Haiti, and North Miami — reserve via [email protected]. Collins Park right outside has Ugo Rondinone's giant neon Miami Mountain sculpture, perfect for photos.", setting: "indoor", estimatedCost: "Free entry · Free bus from Little Havana/Little Haiti (reserve ahead)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎨", source: "arts", typicalHours: "Last Sunday of each month · Art-making 2–4pm · Museum open 12–6pm", seasonalNote: "Free art-making 2–4pm! Free bus from Little Havana & Little Haiti — email [email protected] to reserve.", eventDate: null, daysOpen: [0], url: "https://thebass.org/events/" },
  { id: "bass-babies", lat: 25.7944, lng: -80.1305, name: "The Bass — Bass Babies (Ages 2–4)", location: "The Bass Creativity Center, 2100 Collins Ave, Miami Beach", description: "Weekly art program for children ages 2–4 and their caregivers, running through April 30. Sessions focus on sensory awareness, creativity and pre-literacy skills through hands-on art activities — colors, shapes, patterns, numbers and letters through visual art and music. Led by teaching artist Paloma Dueñas. $20/class for museum members, $25 for nonmembers.", setting: "indoor", estimatedCost: "$20/class (members) · $25/class (non-members) — register at thebass.org", ageRange: "Ages 2–4", ageMin: 2, ageMax: 4, emoji: "👶", source: "arts", typicalHours: "Thursdays 11am–12pm through Apr 30, 2026", seasonalNote: "Last sessions through Apr 30 — book now at thebass.org!", eventDate: "Through Apr 30, 2026", daysOpen: [4], url: "https://thebass.org/education/kids-families-2/" },
  { id: "bass-art-cares-apr11", lat: 25.7944, lng: -80.1305, name: "The Bass — Art Cares: Small World Sculptures", location: "The Bass Creativity Center, 2100 Collins Ave, Miami Beach", description: "Hands-on family art workshop where participants craft personal miniature worlds within terra cotta plates, using texture, color and found objects to bring their visions to life. Part of The Bass's Art Cares series — free family programming on Family Day. All materials provided. Children must be accompanied by an adult. Space is limited — register early at thebass.org.", setting: "indoor", estimatedCost: "Free with required preregistration — thebass.org", ageRange: "All ages (children with adult)", ageMin: 0, ageMax: 17, emoji: "🏺", source: "arts", typicalHours: "Sat Apr 11 · 1:00–3:00pm", seasonalNote: "Free but limited spots — register early at thebass.org!", eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://thebass.org/event/art-cares-small-world-sculptures/" },
  { id: "bass-steam-apr26", lat: 25.7944, lng: -80.1305, name: "The Bass — STEAM+ Student Exhibition & Celebration", location: "The Bass, 2100 Collins Ave, Miami Beach", description: "Celebrate student creativity at The Bass's STEAM+ Student Exhibition — a showcase of art made by Miami-Dade County public school students who participated in The Bass's STEAM+ program. Find inspiration from nature through the Social Assembly: The Communal Table exhibition and Haegue Yang's Coordinates of Speculative Solidarity. Family-friendly afternoon at Miami Beach's contemporary art museum.", setting: "indoor", estimatedCost: "Free with museum admission ($15/adult · $8/youth · Under 6 free)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🔬", source: "arts", typicalHours: "Sun Apr 26 · 2:00–4:00pm", seasonalNote: "Student-made art on display — a great way to celebrate young Miami artists!", eventDate: "Sun Apr 26, 2026", daysOpen: [0], url: "https://thebass.org/event/steam-celebration-2/" },
  { id: "bass-art-gardens-may9", lat: 25.7944, lng: -80.1305, name: "The Bass — Art Cares: Art Gardens", location: "The Bass Creativity Center, 2100 Collins Ave, Miami Beach", description: "Create your own personal garden with paint, tissue paper, natural objects and mixed media in this guided art therapy family workshop. Your garden will reflect your individuality through many different textures — follow your intuition and explore creativity from multiple points of view. Guided by an art therapist. Free, but space is very limited to 15 seats — register early at thebass.org. Children ages 4+ with an adult.", setting: "indoor", estimatedCost: "Free with required preregistration — thebass.org", ageRange: "Ages 4+ (with adult)", ageMin: 4, ageMax: 17, emoji: "🌸", source: "arts", typicalHours: "Sat May 9 · 1:00–3:00pm", seasonalNote: "Only 15 spots! Register early at thebass.org — fills up fast.", eventDate: "Sat May 9, 2026", daysOpen: [6], url: "https://thebass.org/event/art-cares-art-gardens/" },
  { id: "nsu-meec", lat: 26.0177, lng: -80.1108, name: "NSU Marine Environmental Education Center — Free Sea Turtle Encounter", location: "4414 N Surf Rd (Hollywood North Beach Park), Hollywood, FL · ~30 min from Miami", description: "A hidden gem on Hollywood Beach — NSU's free marine education center where you can meet Captain (green sea turtle) and Cane (loggerhead sea turtle), resident ambassador turtles who live there due to injuries that prevent their return to the ocean. Daily sea turtle feeding at 3:30pm where you learn their individual histories and about sea turtle conservation. Also features interactive exhibits on marine debris, coastal ecology, and South Florida's ocean environment, plus direct beach access. The historic 1941 Carpenter House is part of the site. Free parking in the Green Street lot (first-come).", setting: "outdoor", estimatedCost: "Free entry · Free parking (first-come, first-served)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🐢", source: "nature", typicalHours: "Tue–Sat 10am–5pm · Closed Sun & Mon · Sea turtle feeding daily at 3:30pm", seasonalNote: "Daily sea turtle feeding 3:30pm — arrive by 3pm to explore exhibits first!", eventDate: null, daysOpen: [2,3,4,5,6], url: "https://nsuocean.nova.edu/institutes/marine-environmental-education-center/programs-and-events/index.html" },
  { id: "clean-miami-beach-earth-day", lat: 25.7745, lng: -80.1300, name: "Clean Miami Beach: Earth Day Festival & Beach Cleanup", location: "10th Street Beach, Miami Beach (oceanfront)", description: "Celebrate Earth Day by joining Clean Miami Beach for a community beach cleanup right on the sand. Open to all ages — a great way to teach kids about ocean conservation while making a real difference. Cleanup supplies provided (sanitized gloves, buckets, bags, pickers). Wear closed-toed shoes for the dunes, bring a reusable water bottle (refill station on site), and use reef-safe sunscreen. Community service hours available for those who arrive on time. Co-hosted by ECF Wealth, supported by Delta Air Lines, City of Miami Beach and The Miami Foundation.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌊", source: "events", typicalHours: "Sat Apr 19 · Check volunteercleanup.org for exact start time", seasonalNote: "Community service hours available! All supplies provided — just show up.", eventDate: "Sat Apr 19, 2026", daysOpen: [6], url: "https://www.miamiandbeaches.com/event/clean-miami-beach-earth-day-festival-beach-cleanup-2026/38585" },
  // Coral Gables City Events
  { id: "cg-parents-night-out", name: "Parents Night Out", location: "Coral Gables Country Club, Coral Gables", description: "Drop the kids off for a supervised evening of activities at the Country Club while you enjoy a night out. Organized by the City of Coral Gables Recreation department.", setting: "indoor", estimatedCost: "Check site for registration fee", ageRange: "Kids (check age range)", ageMin: 4, ageMax: 12, emoji: "🌙", source: "events", typicalHours: "Evening — check site for exact time", seasonalNote: null, eventDate: "Fri Apr 17, 2026", daysOpen: [5], url: "https://www.coralgables.com/events/parents-night-out" },
  { id: "cg-plogging", name: "Plogging at Chapman/Matheson", location: "Chapman Field / Matheson Hammock, Coral Gables area", description: "Plogging = jogging + picking up litter! Join Keep Coral Gables Beautiful for an active, eco-friendly morning run/walk while cleaning up the park. Great for active families and kids who love the outdoors.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏃", source: "events", typicalHours: "8:30am", seasonalNote: null, eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://www.coralgables.com/events/plogging-chapman" },
  { id: "cg-bike-tours-apr", name: "Gables Bike Tours", location: "Coral Gables Museum, 285 Aragon Ave, Coral Gables", description: "Free guided bike tours of Coral Gables led by BikeWalk Miami and the Coral Gables Museum, exploring the city's stunning architecture, parks, and history. A fun, active family outing — bring your own bikes.", setting: "outdoor", estimatedCost: "Free (check site)", ageRange: "Ages 6+", ageMin: 6, ageMax: 17, emoji: "🚲", source: "events", typicalHours: "Morning — check site for time", seasonalNote: null, eventDate: "Sun Apr 19, 2026", daysOpen: [0], url: "https://www.coralgables.com/events/gables-bike-tours" },
  { id: "cg-arbor-day", name: "Coral Gables Arbor Day Celebration", location: "Fewell Park, Coral Gables", description: "The City of Coral Gables celebrates Arbor Day with a community gathering at Fewell Park. A great free outdoor morning activity for families to learn about trees and enjoy the park.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌳", source: "events", typicalHours: "9:30am – 11:30am", seasonalNote: null, eventDate: "Fri Apr 24, 2026", daysOpen: [5], url: "https://www.coralgables.com/events/arbor-day-celebration" },
  { id: "cg-5k-kids-dash", name: "Tour of the Gables 5K & Kids Dash", location: "Coral Gables (downtown area)", description: "Baptist Health Tour of the Gables features a 5K, 10K, and a dedicated Kids Dash — making it a perfect family racing morning. A great way to make running fun for kids while parents race too.", setting: "outdoor", estimatedCost: "Check site for registration", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏅", source: "events", typicalHours: "Morning — check site for start times", seasonalNote: "Kids Dash included — run as a family!", eventDate: "Sat Apr 25, 2026", daysOpen: [6], url: "https://www.coralgables.com/events/tour-gables-5k" },
  { id: "cg-giralda-live", name: "Giralda Live", location: "Giralda Plaza, Coral Gables", description: "Free monthly street music festival on Giralda Avenue — live bands, food, and a festive community atmosphere. Every first Friday of the month. Great for families to stroll, eat, and enjoy live music outdoors.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎵", source: "events", typicalHours: "Evening — check site for exact time", seasonalNote: null, eventDate: null, daysOpen: [5], url: "https://www.coralgables.com/events/giralda-live" },
  { id: "cg-chopin", name: "Chopin for All — Free Concert", location: "Coral Gables (check site for venue)", description: "Free concert of Chopin works performed by award-winning pianist Charles Richard-Hamelin, presented by the Chopin Foundation of the United States. A beautiful, accessible introduction to classical music for families.", setting: "indoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎹", source: "events", typicalHours: "Check site for time", seasonalNote: "Free world-class classical music — great for curious kids!", eventDate: "Sun May 3, 2026", daysOpen: [0], url: "https://www.coralgables.com/events/chopin-all-featuring-charles-richard-hamelin" },
  { id: "cg-bike-tours-may", name: "Gables Bike Tours (May)", location: "Coral Gables Museum, 285 Aragon Ave, Coral Gables", description: "Monthly guided bike tour of Coral Gables with BikeWalk Miami and the Coral Gables Museum. Explore the city's beautiful streets, parks, and historic architecture. Bring your own bikes.", setting: "outdoor", estimatedCost: "Free (check site)", ageRange: "Ages 6+", ageMin: 6, ageMax: 17, emoji: "🚲", source: "events", typicalHours: "Morning — check site for time", seasonalNote: null, eventDate: "Sun May 17, 2026", daysOpen: [0], url: "https://www.coralgables.com/events/gables-bike-tours" },
  { id: "cg-literacy-fest", name: "Gables Family Literacy Festival", location: "War Memorial Youth Center, Coral Gables", description: "Annual daylong book fair under the Youth Center tree canopy, promoting summer reading and literary arts for kids of all ages. A laid-back, family-friendly outdoor event with activities, books, and authors.", setting: "outdoor", estimatedCost: "Free (check site)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "📚", source: "events", typicalHours: "All day — check site for times", seasonalNote: "Great pre-summer reading kickoff!", eventDate: "Sat May 16, 2026", daysOpen: [6], url: "https://www.coralgables.com/events/gables-family-literacy-festival" },
  { id: "cg-sensory-4th", name: "Sensory Friendly Fourth of July", location: "Biltmore Hotel area, Coral Gables", description: "The City of Coral Gables invites guests with autism and sensory sensitivities to enjoy a premier, quieter viewing area for the Biltmore fireworks display — a wonderful accommodation for families who need a calmer environment.", setting: "outdoor", estimatedCost: "Check site for details", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎆", source: "events", typicalHours: "Evening — check site", seasonalNote: "Sensory-friendly accommodations for kids with autism or sensory needs.", eventDate: "Sat Jul 4, 2026", daysOpen: [6], url: "https://www.coralgables.com/events/sensory-friendly-fourth-july" },
  // UM Earth Month events - April 2026
  // UM Non-Baseball Home Events
  { id: "um-track-alumni-invit", name: "🏃 Canes Track & Field — Hurricane Alumni Invitational", location: "Cobb Stadium, University of Miami, Coral Gables", description: "UM's final home track & field meet of the season — open to spectators, free on the UM campus. Watch sprints, jumps, throws and distance events in a beautiful campus setting. Great live college athletics intro for kids.", setting: "outdoor", estimatedCost: "Free to spectators", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏃", source: "sports", typicalHours: "All day Apr 10–11 — check miamihurricanes.com/sports/track/schedule", seasonalNote: "UM's last home track meet of the outdoor season!", eventDate: "Apr 10 – 11, 2026", daysOpen: [5,6], url: "https://miamihurricanes.com/sports/track/schedule/" },
  { id: "um-wtennis-unc", name: "🎾 Canes Women's Tennis vs. UNC Tar Heels", location: "Neil Schiff Tennis Center, University of Miami, Coral Gables", description: "Miami Hurricanes women's tennis (ranked, 13-4 ACC) hosts UNC at the Neil Schiff Tennis Center on campus. Free to watch — outdoor courts, great live college tennis atmosphere.", setting: "outdoor", estimatedCost: "Free to spectators", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎾", source: "sports", typicalHours: "12:00 PM", seasonalNote: null, eventDate: "Fri Apr 10, 2026", daysOpen: [5], url: "https://miamihurricanes.com/sports/wten/schedule/" },
  { id: "um-mtennis-fsu", name: "🎾 Canes Men's Tennis vs. Florida State", location: "Neil Schiff Tennis Center, University of Miami, Coral Gables", description: "Miami Hurricanes men's tennis hosts longtime rival Florida State at the Neil Schiff Tennis Center on campus. In-state rivalry match — free to watch.", setting: "outdoor", estimatedCost: "Free to spectators", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎾", source: "sports", typicalHours: "12:00 PM", seasonalNote: "Rivalry match vs. Florida State!", eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://miamihurricanes.com/sports/mten/schedule/" },
  { id: "um-volleyball-ucf", name: "🏐 Canes Volleyball vs. UCF Knights", location: "UM Wellness Center / Knight Sports Complex, University of Miami, Coral Gables", description: "Miami Hurricanes women's volleyball hosts UCF on campus. Canes volleyball is a strong NCAA program — great live action for families. Check miamihurricanes.com for ticket info.", setting: "indoor", estimatedCost: "Check miamihurricanes.com for tickets", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏐", source: "sports", typicalHours: "2:00 PM", seasonalNote: null, eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://miamihurricanes.com/sports/wvball/schedule/" },
  { id: "um-wtennis-duke", name: "🎾 Canes Women's Tennis vs. Duke", location: "Neil Schiff Tennis Center, University of Miami, Coral Gables", description: "Miami Hurricanes women's tennis hosts Duke at the Neil Schiff Tennis Center on campus. Free to watch — great Sunday morning college tennis.", setting: "outdoor", estimatedCost: "Free to spectators", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🎾", source: "sports", typicalHours: "12:00 PM", seasonalNote: null, eventDate: "Sun Apr 12, 2026", daysOpen: [0], url: "https://miamihurricanes.com/sports/wten/schedule/" },
  // UM Baseball 2026 home games
  { id: "um-vs-fiu", name: "⚾ Canes Baseball vs. FIU Panthers", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes home baseball vs. FIU. In-state rivalry game at Mark Light Field on the UM campus. Great atmosphere, affordable tickets, family-friendly. Baseball Buddies youth program available. Parking on campus.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:00 PM first pitch", seasonalNote: "In-state rivalry game!", eventDate: "Tue Apr 7, 2026", daysOpen: [2], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-wakeforest-fri", name: "⚾ Canes Baseball vs. Wake Forest (Fri)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series opener vs. Wake Forest at Mark Light Field. Great atmosphere, affordable tickets, family-friendly. Baseball Buddies youth program available.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:00 PM first pitch", seasonalNote: null, eventDate: "Fri Apr 10, 2026", daysOpen: [5], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-wakeforest-sat", name: "⚾ Canes Baseball vs. Wake Forest (Sat)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series game 2 vs. Wake Forest at Mark Light Field. Weekend evening game — great family outing on the UM campus.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:00 PM first pitch", seasonalNote: null, eventDate: "Sat Apr 11, 2026", daysOpen: [6], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-wakeforest-sun", name: "⚾ Canes Baseball vs. Wake Forest (Sun)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series finale vs. Wake Forest at Mark Light Field. Sunday afternoon game — perfect for families.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:00 PM first pitch", seasonalNote: null, eventDate: "Sun Apr 12, 2026", daysOpen: [0], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-usf", name: "⚾ Canes Baseball vs. USF Bulls", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes home baseball vs. USF Bulls at Mark Light Field. Mid-week game — great for a weeknight outing. Baseball Buddies youth program available.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:00 PM first pitch", seasonalNote: null, eventDate: "Wed Apr 15, 2026", daysOpen: [3], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-cal-fri", name: "⚾ Canes Baseball vs. Cal Golden Bears (Fri)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series opener vs. Cal at Mark Light Field. Friday night baseball — great atmosphere on the UM campus.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:00 PM first pitch", seasonalNote: null, eventDate: "Fri Apr 24, 2026", daysOpen: [5], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-cal-sat", name: "⚾ Canes Baseball vs. Cal Golden Bears (Sat)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series game 2 vs. Cal at Mark Light Field. Weekend evening game on the UM campus.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:00 PM first pitch", seasonalNote: null, eventDate: "Sat Apr 25, 2026", daysOpen: [6], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-vs-cal-sun", name: "⚾ Canes Baseball vs. Cal Golden Bears (Sun)", location: "Alex Rodriguez Park at Mark Light Field, University of Miami, Coral Gables", description: "Miami Hurricanes ACC home series finale vs. Cal at Mark Light Field. Sunday afternoon — wrap up the weekend at the ballpark.", setting: "outdoor", estimatedCost: "$12+ general admission", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:00 PM first pitch", seasonalNote: null, eventDate: "Sun Apr 26, 2026", daysOpen: [0], url: "https://miamihurricanes.com/baseball-tickets/" },
  { id: "um-earthday-fair", name: "UM Earth Day Fair", location: "Lakeside Patio, University of Miami, Coral Gables", description: "Free outdoor fair on Earth Day featuring student, faculty, and community sustainability booths, a Yellow Submarine ocean art activation, nature photography competition, green giveaways, and Playa Bowl vouchers. Ends with a free Patio Jams concert with Aisha (2–3:30pm). Open to the public.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌍", source: "sports", typicalHours: "10:30am – 3:30pm", seasonalNote: "Earth Day event — free and open to the public!", eventDate: "Wed Apr 22, 2026", daysOpen: [3], url: "https://greenu.miami.edu/initiatives/nature/earth-day/index.html" },
  { id: "um-arborday", name: "Arbor Day Celebration & Free Concert", location: "Gifford Arboretum, Cox Science Building, 1301 Memorial Dr, Coral Gables", description: "UM's 12th consecutive Tree Campus USA celebration. Starts at 5pm with a guided sensory tree walk through the Gifford Arboretum, followed by a free outdoor concert at 6pm from Frost School of Music artist Maeve McMahon and UM alum Keith Johns. Finger food served. Open to the public.", setting: "outdoor", estimatedCost: "Free", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🌳", source: "sports", typicalHours: "5:00pm – 8:00pm", seasonalNote: "Free concert in the arboretum — beautiful spring evening outing!", eventDate: "Thu Apr 16, 2026", daysOpen: [4], url: "https://greenu.miami.edu/initiatives/nature/earth-day/index.html" },
  { id: "um-coral-movie", name: "Earth Day: Coral Documentary Screening", location: "Coral Gables Art Cinema, Coral Gables", description: "Screening of the 2024 documentary 'With or Without — A Coral Story' followed by a panel discussion with UM Rosenstiel School coral scientists and info on the Rescue a Reef program. A great way for older kids to connect with local ocean conservation. Collaboration between Coral Gables Art Cinema and Green U.", setting: "indoor", estimatedCost: "Check site for ticket price", ageRange: "Ages 8+", ageMin: 8, ageMax: 17, emoji: "🪸", source: "sports", typicalHours: "6:00pm", seasonalNote: "Earth Day documentary — learn about Miami's coral reefs!", eventDate: "Wed Apr 22, 2026", daysOpen: [3], url: "https://greenu.miami.edu/initiatives/nature/earth-day/index.html" },
  { id: "um-scavenger-hunt", name: "UM Earth Month Scavenger Hunt", location: "University of Miami Campus, Coral Gables", description: "ECO Agency's multi-day campus scavenger hunt following daily Instagram clues to discover UM's sustainability programs — recycling, solar panels, gardens, composting and more. Concludes at the Arbor Day celebration on Apr 16 with prizes. Open to all UM community visitors.", setting: "outdoor", estimatedCost: "Free", ageRange: "Ages 8+", ageMin: 8, ageMax: 17, emoji: "🗺️", source: "sports", typicalHours: "Self-paced, Apr 13–16", seasonalNote: "Win prizes including a drone, daypack, and hammock!", eventDate: "Apr 13 – 16, 2026", daysOpen: [0,1,2,3,4,5,6], url: "https://greenu.miami.edu/initiatives/nature/earth-day/index.html" },
  // Miami Marlins 2026 home games
  { id: "marlins-apr17", name: "Marlins vs. Milwaukee Brewers (Fri)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Milwaukee Brewers. Check for Friday fireworks — mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:10 PM", seasonalNote: "Check for Friday fireworks at mlb.com/marlins", eventDate: "Fri Apr 17, 2026", daysOpen: [5], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-apr18", name: "Marlins vs. Milwaukee Brewers (Sat)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Milwaukee Brewers. Weekend game. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "4:10 PM", seasonalNote: null, eventDate: "Sat Apr 18, 2026", daysOpen: [6], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-apr19", name: "Marlins vs. Milwaukee Brewers (Sun)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Milwaukee Brewers. Sunday Funday — check for kids deals. 🎁 Giveaway: Basketball Jersey — Throwback presented by Goya! Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "1:40 PM", seasonalNote: "🏀 Basketball Jersey — Throwback presented by Goya giveaway — arrive early!", eventDate: "Sun Apr 19, 2026", daysOpen: [0], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-apr20", name: "Marlins vs. St. Louis Cardinals (Mon)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the St. Louis Cardinals. Check for $1 Kids Night or special Mon deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "Check for $1 Kids Night special", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: "Check for $1 Kids Night Monday specials", eventDate: "Mon Apr 20, 2026", daysOpen: [1], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-apr21", name: "Marlins vs. St. Louis Cardinals (Tue)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the St. Louis Cardinals. Check for weekday specials. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: null, eventDate: "Tue Apr 21, 2026", daysOpen: [2], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-apr22", name: "Marlins vs. St. Louis Cardinals (Wed)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the St. Louis Cardinals. 4-for-$44 Wednesday bundle often available — check mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "4-for-$44 Wednesday bundle — check site", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:10 PM", seasonalNote: null, eventDate: "Wed Apr 22, 2026", daysOpen: [3], url: "https://www.mlb.com/marlins/tickets" },
  ...
  { id: "marlins-may9", name: "Marlins vs. Washington Nationals (Sat)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Washington Nationals. Weekend game. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "4:10 PM", seasonalNote: null, eventDate: "Sat May 9, 2026", daysOpen: [6], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may10", name: "Marlins vs. Washington Nationals (Sun)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Washington Nationals. Sunday Funday — check for kids deals. 🎁 Giveaway: Mother's Day Clutch! Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:15 PM", seasonalNote: "👜 Mother's Day Clutch giveaway — arrive early!", eventDate: "Sun May 10, 2026", daysOpen: [0], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may18", name: "Marlins vs. Atlanta Braves (Mon)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Atlanta Braves. Check for $1 Kids Night or special Mon deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "Check for $1 Kids Night special", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: "Check for $1 Kids Night Monday specials", eventDate: "Mon May 18, 2026", daysOpen: [1], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may19", name: "Marlins vs. Atlanta Braves (Tue)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Atlanta Braves. Check for weekday specials. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: null, eventDate: "Tue May 19, 2026", daysOpen: [2], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may20", name: "Marlins vs. Atlanta Braves (Wed)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Atlanta Braves. 4-for-$44 Wednesday bundle often available — check mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "4-for-$44 Wednesday bundle — check site", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:10 PM", seasonalNote: null, eventDate: "Wed May 20, 2026", daysOpen: [3], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may21", name: "Marlins vs. Atlanta Braves (Thu)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Atlanta Braves. Weekday game — budget-friendly. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: null, eventDate: "Thu May 21, 2026", daysOpen: [4], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may22", name: "Marlins vs. New York Mets (Fri)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the New York Mets. Check for Friday fireworks — mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:10 PM", seasonalNote: null, eventDate: "Fri May 22, 2026", daysOpen: [5], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may23", name: "Marlins vs. New York Mets (Sat)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the New York Mets. Weekend game. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "4:10 PM", seasonalNote: null, eventDate: "Sat May 23, 2026", daysOpen: [6], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-may24", name: "Marlins vs. New York Mets (Sun)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the New York Mets. Sunday Funday — check for kids deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "1:40 PM", seasonalNote: null, eventDate: "Sun May 24, 2026", daysOpen: [0], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun5", name: "Marlins vs. Tampa Bay Rays (Fri)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Tampa Bay Rays. Check for Friday fireworks — mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:10 PM", seasonalNote: null, eventDate: "Fri Jun 5, 2026", daysOpen: [5], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun6", name: "Marlins vs. Tampa Bay Rays (Sat)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Tampa Bay Rays. Weekend game. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "4:10 PM", seasonalNote: null, eventDate: "Sat Jun 6, 2026", daysOpen: [6], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun7", name: "Marlins vs. Tampa Bay Rays (Sun)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Tampa Bay Rays. Sunday Funday — check for kids deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "1:40 PM", seasonalNote: null, eventDate: "Sun Jun 7, 2026", daysOpen: [0], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun19", name: "Marlins vs. San Francisco Giants (Fri)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the San Francisco Giants. Check for Friday fireworks — mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "7:10 PM", seasonalNote: null, eventDate: "Fri Jun 19, 2026", daysOpen: [5], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun20", name: "Marlins vs. San Francisco Giants (Sat)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the San Francisco Giants. Weekend game. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "4:10 PM", seasonalNote: null, eventDate: "Sat Jun 20, 2026", daysOpen: [6], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun21", name: "Marlins vs. San Francisco Giants (Sun)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the San Francisco Giants. Sunday Funday — check for kids deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "1:40 PM", seasonalNote: "Father's Day — special giveaway likely, check mlb.com/marlins", eventDate: "Sun Jun 21, 2026", daysOpen: [0], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun22", name: "Marlins vs. Texas Rangers (Mon)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Texas Rangers. Check for $1 Kids Night or special Mon deals. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "Check for $1 Kids Night special", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: null, eventDate: "Mon Jun 22, 2026", daysOpen: [1], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun23", name: "Marlins vs. Texas Rangers (Tue)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Texas Rangers. Check for weekday specials. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "From ~$9/child · $20+ adult (varies)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "6:40 PM", seasonalNote: null, eventDate: "Tue Jun 23, 2026", daysOpen: [2], url: "https://www.mlb.com/marlins/tickets" },
  { id: "marlins-jun24", name: "Marlins vs. Texas Rangers (Wed)", location: "loanDepot Park, 501 Marlins Way, Little Havana, Miami", description: "Miami Marlins home game at loanDepot Park vs. the Texas Rangers. 4-for-$44 Wednesday bundle often available — check mlb.com/marlins. Air-conditioned retractable roof stadium — great for South Florida afternoons.", setting: "outdoor", estimatedCost: "4-for-$44 Wednesday bundle — check site", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "⚾", source: "sports", typicalHours: "12:10 PM", seasonalNote: null, eventDate: "Wed Jun 24, 2026", daysOpen: [3], url: "https://www.mlb.com/marlins/tickets" },

  { id: "kidstrong", lat: 25.6617, lng: -80.4158, name: "KidStrong Kendall", location: "13550 SW 120th St, Suite 504, Kendall, Miami", description: "Science-based kids training program with 45-minute weekly classes focused on physical, mental, and character development for kids walking through age 11. Classes run Mon–Thu afternoons (4:15–7:15pm) and Sat–Sun mornings (9:15am–1:15pm). Membership required — first class free trial available. Great for building confidence, athleticism, and social skills.", setting: "indoor", estimatedCost: "Membership required · Free trial class available", ageRange: "Walking – Age 11", ageMin: 0, ageMax: 11, emoji: "💪", source: "play", typicalHours: "Mon–Thu 4:15–7:15pm · Sat–Sun 9:15am–1:15pm · Fri closed", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,6], url: "https://www.kidstrong.com/locations/kendall" },
  { id: "f1-miami-race", lat: 25.9581, lng: -80.2389, name: "🏎️ F1 Miami Grand Prix 2026 — Race Weekend", location: "Hard Rock Stadium, 347 Don Shula Dr, Miami Gardens", description: "Formula 1 returns to Miami for the 2026 Miami Grand Prix — Round 4 of the FIA Formula 1 World Championship. The full weekend includes practice sessions, qualifying, and the main race on Sunday May 3. Circuit surrounds Hard Rock Stadium. Tickets required for circuit access — various grandstands and general admission options available. Combine with the free Fan Fest at Miami Beach (Apr 29 – May 3) for the full experience without a circuit ticket.", setting: "outdoor", estimatedCost: "Tickets from ~$200+ — check tickets.formula1.com", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏎️", source: "sports", typicalHours: "Fri May 1: Practice · Sat May 2: Qualifying · Sun May 3: Race (time TBC)", seasonalNote: "🏁 Round 4 of the 2026 F1 World Championship — right here in Miami!", eventDate: "May 1 – 3, 2026", daysOpen: [5,6,0], url: "https://www.formula1.com/en/racing/2026/miami" },
  { id: "f1-fanfest", lat: 25.7759, lng: -80.13, name: "F1 Miami Grand Prix — Fan Fest", location: "Lummus Park, Miami Beach (oceanfront)", description: "The first-ever official F1 Miami Grand Prix Fan Fest transforms Lummus Park on Miami Beach into a free, five-day celebration. Expect F1 personalities, DJ sets, live stage moments, fan competitions, food and drinks, and immersive racing experiences. FREE to attend — reserve tickets at f1miamigp.com.", setting: "outdoor", estimatedCost: "FREE (register online)", ageRange: "All ages", ageMin: 0, ageMax: 17, emoji: "🏎️", source: "sports", typicalHours: "Wed Apr 29 & Thu Apr 30: 2–6pm · Fri May 1 – Sun May 3: Noon–6pm", seasonalNote: "Historic first-ever official Fan Fest! Perfect family intro to F1 race week without circuit ticket prices.", eventDate: "Apr 29 – May 3, 2026", daysOpen: [0,3,4,5,6], url: "https://f1miamigp.com/fan-fest/" },
  { id: "mchm", lat: 25.7836, lng: -80.1817, name: "Miami Children's Museum", location: "980 MacArthur Causeway, Watson Island, Miami", description: "Hands-on, imaginative exhibits across 56,000 sq ft designed for kids up to age 12 — including a new Playful Putters indoor mini golf exhibit. Features recurring programs: Mini Mondays (infants/toddlers), Sensory Friendly Saturdays, Fit Fridays, and Baby STEAM. Florida residents get $18 admission; Bank of America cardholders get one free ticket the first weekend of each month.", setting: "indoor", estimatedCost: "$26 general · $18 FL residents · Members free", ageRange: "Ages 0–12", ageMin: 0, ageMax: 12, emoji: "🧒", source: "arts", typicalHours: "Daily 10am–6pm", seasonalNote: null, eventDate: null, daysOpen: [0,1,2,3,4,5,6], url: "https://www.miamichildrensmuseum.org/" },
];
...
[{"name":string,"location":"Miami Children's Museum, 980 MacArthur Causeway, Miami","description":string,"setting":"indoor","estimatedCost":string,"ageRange":string,"emoji":string,"typicalHours":string,"eventDate":string|null,"seasonalNote":string|null,"url":"https://www.miamichildrensmuseum.org/upcoming-events"}]`,
  ...
  {
    key: "events-munchkinfun",
    label: "🎉 Munchkin Fun Events",
    prompt: (dateCtx) =>
      `Search munchkinfun.com/miami/cal for upcoming family events in Miami. ${dateCtx} Look for kid-friendly events on or near this date including storytimes, festivals, classes, free events, movies, performances, and community activities. Exclude events already covered by major venues (Zoo Miami, Frost Science, PAMM, Inter Miami games). Focus on smaller community events, free activities, and unique family experiences. Return up to 4 as a JSON array only:
[{"name":string,"location":string,"description":string,"setting":"indoor"|"outdoor","estimatedCost":string,"ageRange":string,"emoji":string,"typicalHours":string,"eventDate":string|null,"seasonalNote":string|null,"url":string|null}]`,
  },
];
...
async function fetchGeneralAI(dateInfo) {
  ...
  const match = text.replace(/```json|```/g, "").match(/\[[\s\S]*\]/);
  if (!match) return [];
  try { return JSON.parse(match[0]).map(r => ({ ...r, source: "play" })); } catch { return []; }
}
...
const COMING_UP = [
  ...
  { date: "2026-06-10", emoji: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", name: "England vs Costa Rica (Orlando)", detail: "Inter&Co Stadium, Orlando · 4pm ET · Pre-WC friendly", url: "https://www.orlandocitysc.com/news/inter-co-stadium-set-to-host-england-in-pre-world-cup-match-against-costa-rica-on-june-10" },
...
export default function App() {
  ...
  async function handleSearch() {
    ...
    const livePromises = LIVE_SOURCES.map(async (src) => {
      try {
        ...
        const tagged = items.map(r => ({ ...r, source: src.key.split("-")[0] }));
  ...
  function handleSave() {
    ...
    setCustomBank(prev => [...prev, {
      ...form, id: "custom-" + Date.now(), source: "play",
    ...
    <>
      ...
      <div className="app">
        ...
        <div className="results">
          ...
          {(() => {
            const isFreeEntry = a => { const c = (a.estimatedCost || "").toLowerCase().trim(); return c === "" || c === "0" || c.startsWith("free") || c.startsWith("low cost or free"); };
...
function loadLeaflet(cb) {
  ...
  if (leafletLoaded) { const wait = () => window.L ? cb() : setTimeout(wait, 50); wait(); return; }
  leafletLoaded = true;
...
function ResultsMap({ venues }) {
  const mapRef = React.useRef(null);
  const mapInstanceRef = React.useRef(null);

  React.useEffect(() => {
    if (!venues || venues.length === 0) return;
    const mappable = venues.filter(v => v.lat && v.lng);
    ...
    loadLeaflet(() => {
      ...
      const map = L.map('results-map-container', { zoomControl: true, scrollWheelZoom: false });
      ...
      const bounds = [];
      mappable.forEach(v => {
        const color = GROUP_COLORS[v.source] || '#00e6e6';
        const icon = L.divIcon({
          className: '',
          html: `<div style="width:28px;height:28px;border-radius:50%;background:${color};border:2.5px solid rgba(255,255,255,0.85);display:flex;align-items:center;justify-content:center;font-size:13px;box-shadow:0 2px 8px rgba(0,0,0,0.5)">${v.emoji || '📍'}</div>`,
          iconSize: [28, 28],
          iconAnchor: [14, 14],
          popupAnchor: [0, -16],
        });
        const marker = L.marker([v.lat, v.lng], { icon }).addTo(map);
        marker.bindPopup(`<strong>${v.name}</strong>${v.typicalHours ? '<span style="color:rgba(180,210,255,0.6);font-size:11px">' + v.typicalHours + '</span>' : ''}${v.estimatedCost ? '<span style="color:#00e6e6;font-size:11px">💰 ' + v.estimatedCost + '</span>' : ''}`);
    ...
    <div className="results-map">
      <div className="results-map-inner">
        <div className="results-map-header">
          <span>🗺️ &nbsp;Map — {mappable.length} location{mappable.length !== 1 ? 's' : ''}</span>
        </div>
